...
const PREVIEW_QUERY_MOBILE_EMULATION_PARAM = '__mtMobile';
...
export function buildProxyUrl(
  ...
  if (buildOptions.mobileEmulation) {
    proxyUrl.searchParams.set(PREVIEW_QUERY_MOBILE_EMULATION_PARAM, '1');
  }
...
export function stripInternalPreviewQueryParams(url: URL): void {
  ...
  url.searchParams.delete(PREVIEW_QUERY_MOBILE_EMULATION_PARAM);
}
